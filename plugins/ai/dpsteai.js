...
const pluginConfig = {
    ...
    category: 'ai',
    description: 'Chatea con IA de dipastebin.web.id (soporta sesión por usuario)',
    usage: '.dpsteai <pregunta> o .dpsteai reset (para borrar sesión)',
    example: '.dpsteai hola',
    isOwner: false,
    cooldown: 5,
    energi: 1,
    isEnabled: true
