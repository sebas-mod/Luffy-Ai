...
const LIBUR = {
  "1-1":  { nama: "Año Nuevo (Masehi)", tipe: "nasional" },
  "1-16": { nama: "Isra Mi'raj del Profeta Muhammad SAW", tipe: "keagamaan" },
  "2-16": { nama: "Día libre conjunto (Año Nuevo Chino)", tipe: "cuti" },
  "2-17": { nama: "Año Nuevo Chino 2577 Kongzili", tipe: "budaya" },
  "3-18": { nama: "Día libre conjunto (Nyepi)", tipe: "cuti" },
  "3-19": { nama: "Nyepi (Año Nuevo Saka 1948)", tipe: "keagamaan" },
  "3-20": { nama: "Día libre conjunto (Idul Fitri)", tipe: "cuti" },
  "3-21": { nama: "Idul Fitri 1447 H", tipe: "keagamaan" },
  "3-22": { nama: "Idul Fitri 1447 H", tipe: "keagamaan" },
  "3-23": { nama: "Día libre conjunto (Idul Fitri)", tipe: "cuti" },
  "3-24": { nama: "Día libre conjunto (Idul Fitri)", tipe: "cuti" },
  "4-3":  { nama: "Muerte de Jesucristo (Viernes Santo)", tipe: "keagamaan" },
  "4-5":  { nama: "Resurrección de Jesucristo (Pascua)", tipe: "keagamaan" },
  "5-1":  { nama: "Día Internacional del Trabajo", tipe: "nasional" },
  "5-14": { nama: "Ascensión de Jesucristo", tipe: "keagamaan" },
  "5-15": { nama: "Día libre conjunto (Ascensión de Jesucristo)", tipe: "cuti" },
  "5-27": { nama: "Idul Adha 1447 H", tipe: "keagamaan" },
  "5-28": { nama: "Día libre conjunto (Idul Adha)", tipe: "cuti" },
  "5-31": { nama: "Waisak 2570 BE", tipe: "keagamaan" },
  "6-1":  { nama: "Día del nacimiento de Pancasila", tipe: "nasional" },
  "6-16": { nama: "Año Nuevo Islámico 1448 H", tipe: "keagamaan" },
  "8-17": { nama: "Día de la Independencia de la República de Indonesia", tipe: "nasional" },
  "8-25": { nama: "Maulid del Profeta Muhammad SAW", tipe: "keagamaan" },
  "12-24": { nama: "Día libre conjunto (Navidad)", tipe: "cuti" },
  "12-25": { nama: "Día de Navidad", tipe: "keagamaan" },
};
...
function gambarLegenda(ctx, x, y, w, h) {
  ...
  const item = [
    { label: "Día Nacional", warna: WARNA.tipe.nasional },
    { label: "Fiestas Religiosas", warna: WARNA.tipe.keagamaan },
    { label: "Día Cultural", warna: WARNA.tipe.budaya },
    { label: "Día Libre Conjunto", warna: WARNA.tipe.cuti },
  ];
