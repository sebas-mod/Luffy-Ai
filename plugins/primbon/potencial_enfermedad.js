...
const pluginConfig = {
    name: 'potencial_enfermedad',
    alias: ["ver_enfermedad", "enfermedad"],
    category: 'primbon',
    description: 'Revisar la posible enfermedad según la fecha de nacimiento',
    usage: '.potencial_enfermedad <dia> <mes> <año>',
    example: '.potencial_enfermedad 12 05 1998',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    if (m.args.length < 3) {
        return m.reply(`🏥 *ᴘᴏsɪʙʟᴇ ᴇɴꜰᴇʀᴍᴇᴅᴀᴅ*\n\n> Formato: día mes año\n\n\`Ejemplo: ${m.prefix}potencial_enfermedad 12 05 1998\``)
    }
