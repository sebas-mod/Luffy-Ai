...
const pluginConfig = {
    name: ['noticias', 'antara', 'cnn', 'cnbc', 'sindonews'],
    alias: [],
    category: 'info',
    description: 'Obtener las últimas noticias de varias fuentes',
    usage: '.noticias <fuente>',
    example: '.noticias cnn',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m) {
    ...
    if (cmd === 'noticias') {
        ...
        if (!arg) {
            let txt = `📰 *ʟɪꜱᴛᴀ ᴅᴇ ꜰᴜᴇɴᴛᴇs ᴅᴇ ɴᴏᴛɪᴄɪᴀs*\n\n`
