...
const pluginConfig = {
  ...
  category: "rpg",
  description: "Enviar expediciones automáticas por ítems",
...
const EXPEDITIONS = {
  forest: { name: "🌲 Bos de las Arañas", duration: 1800000, rewards: ["wood", "herb", "mushroom"], exp: 100, minLevel: 1 },
  cave: { name: "🏔️ Cueva de los Murciélagos", duration: 3600000, rewards: ["iron", "gold", "gem"], exp: 200, minLevel: 5 },
  volcano: { name: "🌋 Montaña del Dragón", duration: 7200000, rewards: ["lava", "dragonscale", "titancore"], exp: 400, minLevel: 15 },
  ocean: { name: "🌊 Mar del Kraken", duration: 5400000, rewards: ["fish", "pearl", "seagem"], exp: 300, minLevel: 10 },
