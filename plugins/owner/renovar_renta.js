...
const pluginConfig = {
  ...
  usage: ".renovar_renta <link/id grupo> <duración>",
  example: ".renovar_renta https://chat.whatsapp.com/xxx 30d",
  isOwner: true,
  isPremium: false,
  isGroup: false,
  isPrivate: false,
  ...
  if (args.length < 2) {
    return m.reply(
      `📝 *RENOVAR ALQUILER*\n` +
        ...
        `• lifetime = Permanente\n\n` +
        `*EJEMPLO:*\n` +
        `• ${m.prefix}renovar_renta https://chat.whatsapp.com/xxx 30d\n` +
        `• ${m.prefix}renovar_renta 120363xxx 1m\n\n` +
