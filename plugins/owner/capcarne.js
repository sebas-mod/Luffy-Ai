...
async function handler(m, { sock }) {
  if (m.args.length < 2) {
    return m.reply(
      ...
      `*USO:*\n` +
      `- *${m.prefix}capcarne <nombre_función1> <nombre_función2> ... <cantidad>*\n\n` +
      `*EJEMPLO DE USO:*\n` +
      `- *${m.prefix}capcarne hd jpm 5* (Las funciones HD y JPM descuentan 5 de energía)\n` +
      `- *${m.prefix}capcarne hd 0* (La función HD queda gratis en energía)\n\n` +
      `*EXPLICACIÓN:*\n` +
