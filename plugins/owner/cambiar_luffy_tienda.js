...
const pluginConfig = {
    name: 'cambiar_luffy_tienda',
    alias: ["configurar_luffy_tienda"],
    category: 'owner',
    description: 'Cambiar la imagen luffy-store.jpg (miniatura de tienda)',
    usage: '.cambiar_luffy_tienda (responde/envía imagen)',
    example: '.cambiar_luffy_tienda',
    isOwner: true,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
