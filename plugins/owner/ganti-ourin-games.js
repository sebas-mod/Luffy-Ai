...
const pluginConfig = {
    ...
    category: 'owner',
    description: 'Cambia la imagen ourin-games.jpg (mestoatura de juegos)',
    usage: '.ganti-ourin-games.jpg (reply/envía imagen)',
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        try {
            ...
            m.reply(`✅ *ʙᴇʀʜᴀsɪʟ*\n\n> Imagen ourin-games.jpg ha sido cambiado a una nueva URL:\n> ${newUrl}\n> Config ha sido actualizado en tiempo real!`)
        } catch (e) {
