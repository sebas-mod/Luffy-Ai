...
const pluginConfig = {
    ...
    category: 'owner',
    description: 'Cambia la imagen ourin-welcome.jpg (mestoatura de bienvenida)',
    usage: '.ganti-ourin-welcome.jpg (reply/envía imagen)',
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        try {
            ...
            m.reply(`✅ *ᴇxɪᴛᴏ*\n\n> Imagen ourin-welcome.jpg ha sido cambiado a una nueva URL:\n> ${newUrl}\n> Config ha sido actualizado en tiempo real!`)
        } catch (e) {
