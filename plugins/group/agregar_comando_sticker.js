...
const pluginConfig = {
    name: 'agregar_comando_sticker',
    alias: ["addstickercmd", "stickeradd"],
    category: 'group',
    description: 'Convertir un sticker en un acceso directo de comando',
    usage: '.agregar_comando_sticker <comando> (responde un sticker)',
    example: '.agregar_comando_sticker menu',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
