...
const EFFECTS = {
    ...
    tremolo:   { emoji: '〰️', filter: 'tremolo=f=8:d=0.7', desc: 'Tremolo / vibración' },
...
async function handler(m, { sock }) {
    ...
    if (!fx) {
        return m.reply(
            ...
            `Escribe *${m.prefix}audiofx list* para la lista de efectos`
        )
    }
