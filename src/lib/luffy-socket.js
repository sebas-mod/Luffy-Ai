...
import { addExifToWebp, DEFAULT_METADATA } from "./luffy-exif.js";
...
async function extendSocket(sock) {
  ...
  sock.sendMedia = async function (
    ...
    if (Buffer.isBuffer(source)) {
      ...
      throw new Error(
        "La fuente debe ser Buffer, URL string, ruta de archivo, objeto { url } o payload de media",
      );
