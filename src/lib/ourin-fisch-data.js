...
const fishingRod = {
  ...
  ancientrod: { name: "Ancient Rod", luck: 0.20, speed: 0.20, comboFish: 2, comboMutations: 2, mutationsLuck: 0.015, sellMultiplier: 0.50, price: 25000000, description: "Caña antigua — mutaciones combo mejoradas.", level: 1, maxLevel: 25, exp: 0, expToNextLevel: 100 },
  ...
  depthseekerrod: { name: "Depthseeker Rod", luck: 0.55, speed: 0.48, comboFish: 4, comboMutations: 3, mutationsLuck: 0.060, sellMultiplier: 1.30, price: 25000000000, description: "Caña exploradora del océano profundo.", level: 1, maxLevel: 50, exp: 0, expToNextLevel: 100 },
...
const rodEnchants = {
  ...
  skilled: { name: "Skilled", rarity: "common", effect: { xpMultiplier: 1.25 }, desc: "XP adicional en cada captura." },
  divine: { name: "Divine", rarity: "rare", effect: { luck: 1.45 }, desc: "Buena suerte." },
  ...
  glittered: { name: "Glittered", rarity: "epic", effect: { mutationChance: 0.03 }, desc: "Oportunidad de mutación +3%" },
  ...
  royalcrest: { name: "Royal Crest", rarity: "legendary", effect: { luck: 2.0, sellMultiplier: 2.5 }, desc: "Símbolo del rey del mar, valor y suerte excepcionales." },
  ...
  phantom: { name: "Phantom", rarity: "legendary", effect: { luck: 1.8, mutationChance: 0.05 }, desc: "Energía del espíritu marino, suerte y mutaciones raras." },
  ...
  abyssborn: { name: "Abyssborn", rarity: "mythic", effect: { luck: 2.2, mutationChance: 0.12, sellMultiplier: 4 }, desc: "Poder del mar profundo." },
  ...
  reapersnet: { name: "Reaper's Net", rarity: "godly", effect: { luck: 4.0, progressSpeed: 2.0, sellMultiplier: 7 }, desc: "Red del segador del mar." },
  timeless: { name: "Timeless", rarity: "secret", effect: { luck: 5.0, progressSpeed: 2.0, xpMultiplier: 3 }, desc: "La energía del tiempo te guía." },
  voidheart: { name: "Voidheart", rarity: "secret", effect: { luck: 6.0, mutationChance: 0.25, sellMultiplier: 12 }, desc: "Inti del vacío, mutaciones y valor extremo." },
