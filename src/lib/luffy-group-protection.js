...
import { isLid, lidToJid, lidToJidSafe } from "./luffy-lid.js";
...
function gpMsg(key, replacements = {}) {
  const defaults = {
    ...
    antilinkGcKick:
      "⚠ *Antilink WA* — @%user% fue expulsado por enviar enlaces de WA.",
    ...
    antiswgc: "⚠ *AntiSWGC* — Estado de grupo tipo *%type%* de @%user% eliminado.",
    antijudol:
      "⚠ *AntiJudol* — @%user% detectado enviando contenido de apuestas.\nMensaje eliminado.",
    antijudolKick: "⚠ *AntiJudol* — @%user% fue expulsado por contenido de apuestas.",
    antiphising:
      "⚠ *Antiphishing* — @%user% detectado enviando contenido de phishing.\nMensaje eliminado.",
    antiphisingKick:
      "⚠ *Antiphishing* — @%user% fue expulsado por contenido de phishing.",
    anticustom:
      "⚠ *AntiCustom* — @%user% violó la regla personalizada *%rule%*.\nMensaje eliminado.",
    anticustomKick:
      "⚠ *AntiCustom* — @%user% fue expulsado por violar la regla *%rule%*.",
...
const JUDOL_PATTERNS = [
  { pattern: /\bjud[iol]{1,4}\b/i, score: 3, label: "juego" },
  { pattern: /\bslot\b/i, score: 3, label: "tragamonedas" },
  { pattern: /\bgacor\b/i, score: 3, label: "tragamonedas caliente" },
  { pattern: /\bslot\s+gacor\b/i, score: 4, label: "tragamonedas caliente" },
  { pattern: /\bmax\s?win\b/i, score: 3, label: "maxwin" },
  { pattern: /\bscatter\b/i, score: 2, label: "scatter" },
  { pattern: /\btogel\b/i, score: 3, label: "lotería" },
  ...
  { pattern: /\bfree\s?spin\b/i, score: 2, label: "giro gratis" },
  { pattern: /\bspin\s?gratis\b/i, score: 2, label: "giro gratis" },
  { pattern: /\bpola\s?slot\b/i, score: 2, label: "patrón de tragamonedas" },
  { pattern: /\bdeposit\b/i, score: 1, label: "depósito" },
  { pattern: /\bdepo\b/i, score: 1, label: "depósito" },
  { pattern: /\bwithdraw\b/i, score: 1, label: "retiro" },
  { pattern: /\bwd\b/i, score: 1, label: "retiro" },
  { pattern: /bonus\s+new\s+member/i, score: 2, label: "bono de bienvenida" },
  {
    pattern: /bonus\s+(member|new\s*member)/i,
    score: 2,
    label: "bono de miembro",
  },
  { pattern: /link\s+alternatif/i, score: 2, label: "enlace alternativo" },
  { pattern: /bandar\s+(slot|togel|judi)/i, score: 2, label: "casa de apuestas" },
  { pattern: /\bbet\s?(kecil|besar)?\b/i, score: 1, label: "apuesta" },
  { pattern: /\btaruhan\b/i, score: 2, label: "apuesta" },
];
const JUDOL_COMPACT_KEYWORDS = [
  { keyword: "judi", score: 3, label: "juego" },
  { keyword: "judol", score: 3, label: "juego" },
  { keyword: "slot", score: 3, label: "tragamonedas" },
  { keyword: "gacor", score: 3, label: "tragamonedas caliente" },
  { keyword: "slotgacor", score: 4, label: "tragamonedas caliente" },
  { keyword: "maxwin", score: 3, label: "maxwin" },
  { keyword: "scatter", score: 2, label: "scatter" },
  { keyword: "togel", score: 3, label: "lotería" },
  ...
  { keyword: "freespin", score: 2, label: "giro gratis" },
  { keyword: "spingratis", score: 2, label: "giro gratis" },
  { keyword: "polaslot", score: 2, label: "patrón de tragamonedas" },
  { keyword: "bonusmember", score: 2, label: "bono de miembro" },
  { keyword: "bonusnewmember", score: 2, label: "bono de bienvenida" },
  { keyword: "linkalternatif", score: 2, label: "enlace alternativo" },
  { keyword: "bandarslot", score: 2, label: "casa de apuestas" },
  { keyword: "bandartogel", score: 2, label: "casa de apuestas" },
  { keyword: "bandarjudi", score: 2, label: "casa de apuestas" },
];
const PHISHING_PATTERNS = [
  { pattern: /klik\s+(link|tautan)/i, score: 2, label: "clic en enlace" },
  { pattern: /(tap|tekan)\s+(link|tautan)/i, score: 2, label: "tocar enlace" },
  {
  ...
  { pattern: /masuk\s+(disini|di\s+sini)/i, score: 2, label: "iniciar sesión" },
  {
  ...
  { pattern: /hadiah\s+(gratis|menarik|langsung)/i, score: 1, label: "premio" },
  { pattern: /cek\s+(resi|paket|rekening)/i, score: 1, label: "consultar" },
  { pattern: /reset\s+(password|akun)/i, score: 3, label: "restablecer" },
  { pattern: /pulihkan\s+akun/i, score: 3, label: "recuperar cuenta" },
  {
  ...
  { pattern: /isi\s+form(ulir)?/i, score: 2, label: "formulario" },
  { pattern: /akses\s+(sekarang|link)/i, score: 1, label: "acceder" },
  { pattern: /hadiah\s+menanti/i, score: 1, label: "premio esperando" },
];
const PHISHING_COMPACT_KEYWORDS = [
  { keyword: "kliklink", score: 2, label: "clic en enlace" },
  { keyword: "kliktautan", score: 2, label: "clic en enlace" },
  { keyword: "taplink", score: 2, label: "tocar enlace" },
  { keyword: "tekanlink", score: 2, label: "tocar enlace" },
  { keyword: "verifikasiakun", score: 3, label: "verificar cuenta" },
  { keyword: "verifikasinomor", score: 3, label: "verificar número" },
  { keyword: "verifikasirekening", score: 3, label: "verificar cuenta" },
  { keyword: "verifikasiwallet", score: 3, label: "verificar billetera" },
  { keyword: "loginsekarang", score: 3, label: "iniciar sesión ahora" },
  { keyword: "logindisini", score: 3, label: "iniciar sesión aquí" },
  { keyword: "masukdisini", score: 2, label: "iniciar sesión aquí" },
  { keyword: "kodeotp", score: 2, label: "código otp" },
  { keyword: "kodeverifikasi", score: 2, label: "código de verificación" },
  { keyword: "resetpassword", score: 3, label: "restablecer contraseña" },
  { keyword: "resetakun", score: 3, label: "restablecer cuenta" },
  { keyword: "pulihkanakun", score: 3, label: "recuperar cuenta" },
  { keyword: "klaimhadiah", score: 2, label: "reclamar premio" },
  { keyword: "klaimsaldo", score: 2, label: "reclamar saldo" },
  { keyword: "klaimbonus", score: 2, label: "reclamar bono" },
  { keyword: "saldogratis", score: 2, label: "saldo gratis" },
  { keyword: "saldokaget", score: 2, label: "saldo sorpresa" },
  { keyword: "updateakun", score: 2, label: "actualizar cuenta" },
  { keyword: "updaterekening", score: 2, label: "actualizar cuenta" },
  { keyword: "konfirmasiakun", score: 2, label: "confirmar cuenta" },
  { keyword: "konfirmasiidentitas", score: 2, label: "confirmar identidad" },
  { keyword: "isiform", score: 2, label: "llenar formulario" },
];
