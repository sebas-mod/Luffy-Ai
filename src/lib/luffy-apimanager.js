...
/**
 * @typedef {Object} LuffyApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} LuffyApiProviderShape
 * @property {string} baseURL
 * @property {LuffyApiAuthShape} [auth]
...
/**
 * @typedef {Object} LuffyApiRequestOptions
...
/**
 * @typedef {Object} LuffyApiMultipartFile
 ...
 */
class LuffyApiProvider {
  /**
   * @param {LuffyApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {LuffyApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {LuffyApiMultipartFile[]|Object<string, any>} [files]
   * @param {LuffyApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends LuffyApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends LuffyApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends LuffyApiProvider {
...
class ApiFaaProvider extends LuffyApiProvider {
...
class LuffyMainApiProvider extends LuffyApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends LuffyApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends LuffyApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends LuffyApiProvider {
...
class AzbryApiProvider extends LuffyApiProvider {
...
class YuulabsApiProvider extends LuffyApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends LuffyApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends LuffyApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal Luffy.
 */
class LuffyApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @param {LuffyApiProviderShape} cfg
   * @returns {LuffyApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<LuffyApiProviderShape>} cfg
   * @returns {LuffyApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || LuffyApiProvider;
...
const ourinApi = new LuffyApiManager();

export { LuffyApiManager, LuffyApiProvider, ourinApi };
