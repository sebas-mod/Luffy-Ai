...
async function playBootSequence(info = {}) {
  ...
  const banner = [
    "",
    `  ${cGreen(" _     ___ ____  __  __ ___ _   _    _    _     ")}`,
    `  ${cGreen("| |   |_ _|  _ \\|  \\/  |_ _| \\ | |  / \\  | |    ")}`,
    `  ${cGreen("| |    | || | | | |\\/| || ||  \\| | / _ \\ | |    ")}`,
    `  ${cGreen("| |___ | || |_| | |  | || || |\\  |/ ___ \\| |___ ")}`,
    `  ${cGreen("|_____|___|____/|_|  |_|___|_| \\_/_/   \\_\\_____|")}`,
    `  ${cGreen("  __  __  _____  ____    ____  ")}`,
    `  ${cGreen(" |  \\/  |/ _ \\ \\/ ___|  |  _ \\ ")}`,
    `  ${cGreen(" | |\\/| | | | | \\___ \\  | | | |")}`,
    `  ${cGreen(" | |  | | |_| |  ___) | | |_| |")}`,
    `  ${cGreen(" |_|  |_|\\___/  |____/  |____/ ")}`,
    "",
