...
async function checkAndNotifyLevelUp(sock, m, db, user, oldExp, newExp) {
  ...
  if (newLevel > oldLevel) {
    ...
    const txt = `🎊 *FELICIDADES @${m.sender.split("@")[0]}!*

Subiste ${newLevel - oldLevel} niveles
🥗 Tu nivel ahora es *${newLevel}*

Ahora estás en el rango *${role}*

¿Quieres ver el detalle de tu nivel? escribe _${m.prefix}level_

¡Interactúa seguido con el bot para subir de nivel!`;
