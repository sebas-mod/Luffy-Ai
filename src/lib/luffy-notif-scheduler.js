...
const MAKAN_MESSAGES = [
    '🍽️ *¡Hora de comer {label}!*\n\n⏰ *{jam} WIB*\n\nNo te saltes la comida, el cuerpo necesita energía para seguir siendo productivo 💪\n{menu}\n\n📌 _Configurado por @{sender}_',
    '🥗 *¡Oye @{sender}, ya son las {jam}!*\n\nHora de llenar el estómago 🍛\n¡Come algo nutritivo para mantenerte en forma!\n{menu}',
    '🍜 *Recordatorio de comida {label}*\n\n⏰ *{jam} WIB*\n\nEl estómago vacío arruina el ánimo 😤\nCome algo antes de seguir con tus actividades\n{menu}\n\n📌 _Configurado por @{sender}_',
    '🍜 *A COMER YA @{sender}*\n\n¿Qué te preparas? {menu}',
]

const TIDUR_MESSAGES = [
    '🌙 *¡Hora de descansar!*\n\n⏰ *{jam} WIB*\n\nGuarda el celular y cierra los ojos 😴\n¡Dormir bien deja tu mente fresca para mañana!\n_Buenas noches_ 🌟\n\n📌 _Configurado por @{sender}_',
    '💤 *¡Ya son las {jam}, @{sender}!*\n\nDescansa, no trasnoches tanto 🛏️\nLa salud es la inversión más valiosa\n_Que tengas dulces sueños_ ✨',
    '😴 *Recordatorio para dormir*\n\n⏰ *{jam} WIB*\n\nLa pantalla es enemiga del sueño profundo 📵\n¡Apaga las notificaciones y acuéstate ya!\n_Buenas noches_ 🌜\n\n📌 _Configurado por @{sender}_',
    '*A DORMIR YA @{sender}*\n\n⏰ Ya son las *{jam}*',
]
