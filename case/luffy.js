    ...
    switch (command) {
      ...
      case "listallcase": {
        try {
          ...
          text += `*━━━━━━━━━━━━━━━*\n`;
          text += `💡 *ᴛɪᴘ:* Usa \`.listallplugin\` para ver los plugins`;
            ...
            m.chat,
            {
              ...
              contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                  ...
                  newsletterName: "Luffy Case System",
                  serverMessageId: 127,
                },
              },
            },
      ...
      case "listallplugin": {
        try {
          ...
          if (totalPlugins === 0) {
            await m.reply("⚠️ *No hay plugins cargados*");
            return { handled: true };
          }
          ...
          text += `*━━━━━━━━━━━━━━━*\n`;
          text += `💡 *ᴛɪᴘ:* Usa \`.listallcase\` para ver los casos`;
          ...
          await sock.sendMessage(
            m.chat,
            {
              ...
              contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                  newsletterJid: "120363400911374213@newsletter",
                  newsletterName: "Luffy Plugin System",
                  serverMessageId: 127,
                },
              },
            },
